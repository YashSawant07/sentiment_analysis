...
model = pickle.load(open(r"D:\projects\ML Project\Sentiment analysis\Depression sentiment\logisticmodelde.pkl", 'rb'))

encoder = pickle.load(open(r"D:\projects\ML Project\Sentiment analysis\Depression sentiment\encoderde.pkl", 'rb'))

vectorizer = pickle.load(open(r"D:\projects\ML Project\Sentiment analysis\Depression sentiment\countVectorizerde.pkl", 'rb'))
...
category = st.sidebar.selectbox('Choose a category:', ['Depression', 'Positive or Negative'])
...
model_pn = pickle.load(open(r"D:\projects\ML Project\Positive_negative\logisticmodel.pkl", 'rb'))

vectorizer_pn = pickle.load(open(r"D:\projects\ML Project\Positive_negative\countVectorizer.pkl", 'rb'))
